...
def HIKU7(canvas, data_selecionada, hora_selecionada,beta, gamma_p,lat,long_local,long_meridiano):
    ...
    return (temperatura_cel,actual_irradiance,angulos_irradiancia,potencia_desejada,potencia_gerada_modulo,int(quantidade_paineis),short_circuit_current, open_circuit_voltage, temperature_current_coefficient,series_resistance,shunt_resistance,diode_quality_factor, number_of_series_connected_cells)
